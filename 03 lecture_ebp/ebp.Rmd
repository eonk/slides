...
--
.pull-left[<p style="color:purple">Medicine A </p> This medicine is approved by FDA for the treatment of YumYum19 disease... the experiemets... 5k adults for 3 years...

]

--
.pull-right[<p style="color:purple">Medicine B </p> Mate, trust me, you should take one liter of ginger and garlic juice everyday. then YumYum19 disease will be gone. It worked for my uncle's friend's sister's boy friend's dad
]
...
.pull-left[<p style="color:purple">👩🏽‍⚕️ Medicine A </p> This medicine is approved by FDA for the treatment of YumYum19 disease... the experiemets... 5k adults for 3 years...

]


.pull-right[<p style="color:purple">🧙🏼‍️ Medicine B </p><p style="color:grey"> Mate, trust me, you should take one liter of ginger and garlic juice everyday. then YumYum19 disease will be gone. It worked for my uncle's friend's sister's boy friend's dad </p>
]
...
This medicine is approved by FDA for the treatment of YumYum19 disease.
...
--
###🧑‍🔬There is significant evidence about "what works" in treating YumYum19 disease
...
### 'The Doctor Who Championed Hand-Washing and <br> Briefly Saved Lives'
...
###&emsp; “Evidence-based policing means that **the best available evidence** is used to inform and challenge policing policies, practices and decisions.
###&emsp; An evidence-based policing approach can be used by everyone in policing. It can be supported by collaboration with academics and other partners." (College of Policing, 2022)
<p>&nbsp;</p>
<p>&nbsp;</p>
.right[@Spooner and Hughes's ***Police Research and Evidence-Based Policing***]
---
#<p style="color:grey">Research to support evidence-based policing</p>
...
###"It depends...if the sorting hat makes the decision <br> based on empirical, scientific, and controlled research."
...
##"hmmm- let's me give you some examples of <br /> evidence-based policing in action"

---
#<p style="color:grey">Evidence-based poincing in action</p>
###Case 1: Hot spot policing to reduce youth violence
...
The dedicated teams including Operation Reacher, burglary, knife crime, robbery and neighbourhood policing teams should be out and about every day in hot-spot locations across Nottinghamshire protecting the public and preventing crime as well as relentlessly pursuing offenders who break the law.
...
####<p style="color:purple">Evidence</p> 
Crime risks vary consistently and are typically concentrated by the time of day, the day of the week, season, type of holiday and even weather conditions. Additionally, only a few offenders commit most of the crime. Some estimates show that just 3-5 per cent of the population commit 50-60 percent of crime. Additionally, based on the “power few” or loosely connected 20/80 rule, 80 percent of all crime might be committed by 20 percent of the population.
...
##.right["What more is needed for evidence-based policing to bridge the divide between academic research and police practice?"]
...
##"Super good question! It is very important to understand how the evidence from acdemic resaerch will be implemented by the police"
...
###2. Empowering officers to conduct police-led science
...
---
#<p style="color:grey">'Crime Reduction Toolkit'</p>
...
###"I am interested in the impact of **Boot-camps** on crime and want to know how it works."
...
###.right["Yes, I saw the news about it. In NZ, a party has pledged to send serious youth offenders to boot camps (officially called Young Offender Military Academies) if it wins the next election"]


---
<img src="https://user-images.githubusercontent.com/98951792/203861544-7ebb70da-2aaa-426b-9679-250cccaa6b58.png" width="60%"/ style="float:center">


<img src="https://user-images.githubusercontent.com/98951792/203441875-bbac5be6-1246-4e06-bf49-f8d22f09ef91.png" width="15%"/ style="float:left">
###"Look, they say it works!!!!."

######[‘Fitter, faster criminals’: Wide condemnation of National’s youth crime policy](https://www.nzherald.co.nz/nz/politics/fitter-faster-criminals-wide-condemnation-of-nationals-youth-crime-policy/F24MEONH6JBETHCHP6N6ZTCIP4/)
---

<img src="https://user-images.githubusercontent.com/98951792/203861241-f13d67e2-9eba-44fa-aaee-fb04a532ace2.png" width="60%"/ style="float:center">

<img src="https://user-images.githubusercontent.com/98951792/203454682-48ad98b7-e1dc-4761-894a-a81057148500.png" width="15%"/ style="float:right">
###.right["Look, they say it does not work!!!!."]

######[National’s youth offender ‘military academy’ idea slammed by experts](https://www.nzherald.co.nz/nz/its-a-joke-nationals-youth-offender-military-academy-idea-slammed-by-experts/OWJJJV2GTFFZPM7YBSAIYSBK3M/)
---
#<p style="color:grey"> 'Crime Reduction Toolkit'</p>

<img src="https://user-images.githubusercontent.com/98951792/203862584-39b1fe53-8a4e-4448-a4a7-18bf5329891f.png" width="15%"/ style="float:left">
###"What the policy’s advocates and detractors have said about Boot-camps is not the same...so 'WHAT WORKS'? Does the intervention reduce crime or not??"
...
###.right["There is Crime Reduction Toolkit developed by researchers. Let's have a look and find evidence"]
...
<p>&nbsp;</p>
<p>&nbsp;</p>
###.left["In summary we can say... <br> - There is some evidence that the intervention has either increased or reduced crime, but overall the intervention has not had a statistically significant effect on crime. <br> - Boot camps with an evidence-based therapeutic focus see the largest reductions in recidivism among participants."]
...
--
###"Now, what would be your 'crime reduction recommemdation' of boot-camps intervention? Shall we discuss?"
---
